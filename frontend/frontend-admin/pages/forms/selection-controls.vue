          ...
          <v-widget title="Checkbox">
            <div slot="widget-content">
              <div class="basic">
                ...
                <v-checkbox :label="`Disabled : ${checkbox3.toString()}`" color="success" disabled v-model="checkbox3"></v-checkbox>
                <v-checkbox :label="`Indeterminate : ${checkbox4.toString()}`" color="success" indeterminate v-model="checkbox4"></v-checkbox>
              </div>
              <div class="multile">
                <v-container fluid class="pa-0">
                  <v-layout row wrap>
                    ...
                    <v-flex xs12 sm4 md4>
                      ...
                      <v-checkbox label="red darken-3" v-model="colors" color="red darken-3" value="red darken-3" hide-details></v-checkbox>
                    </v-flex>
                    <v-flex xs12 sm4 md4>
                      <v-checkbox label="indigo" v-model="colors" color="indigo" value="indigo" hide-details></v-checkbox>
                      <v-checkbox label="indigo darken-3" v-model="colors" color="indigo darken-3" value="indigo darken-3" hide-details></v-checkbox>
                    </v-flex>
                    <v-flex xs12 sm4 md4>
                      <v-checkbox label="orange" v-model="colors" color="orange" value="orange" hide-details></v-checkbox>
                      <v-checkbox label="orange darken-3" v-model="colors" color="orange darken-3" value="orange darken-3" hide-details></v-checkbox>
                    </v-flex>
                  </v-layout>
                  <v-layout row wrap>
                    <v-flex xs12 sm4 md4>
                      <v-checkbox label="primary" v-model="colors" color="primary" value="primary" hide-details></v-checkbox>
                      <v-checkbox label="secondary" v-model="colors" color="secondary" value="secondary" hide-details></v-checkbox>
                    </v-flex>
                    <v-flex xs12 sm4 md4>
                      <v-checkbox label="success" v-model="colors" color="success" value="success" hide-details></v-checkbox>
                      <v-checkbox label="info" v-model="colors" color="info" value="info" hide-details></v-checkbox>
                    </v-flex>
                    <v-flex xs12 sm4 md4>
                      <v-checkbox label="warning" v-model="colors" color="warning" value="warning" hide-details></v-checkbox>
