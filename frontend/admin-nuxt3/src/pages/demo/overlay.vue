    ...
    <div class="col-12 lg:col-6">
      ...
      <div class="card">
        ...
        <Sidebar v-model:visible="visibleLeft" :base-z-index="1000">
          ...
          <Button type="button" label="Save" class="p-button-success" style="margin-right: 0.25em" @click="visibleLeft = false" />
        ...
        <Sidebar v-model:visible="visibleRight" :base-z-index="1000" position="right">
          ...
          <Button type="button" label="Save" class="p-button-success" style="margin-right: 0.25em" @click="visibleRight = false" />
        ...
        <Sidebar v-model:visible="visibleTop" :base-z-index="1000" position="top">
          ...
          <Button type="button" label="Save" class="p-button-success" style="margin-right: 0.25em" @click="visibleTop = false" />
        ...
        <Sidebar v-model:visible="visibleBottom" :base-z-index="1000" position="bottom">
          ...
          <Button type="button" label="Save" class="p-button-success" style="margin-right: 0.25em" @click="visibleBottom = false" />
        ...
        <Sidebar v-model:visible="visibleFull" :base-z-index="1000" position="full">
          ...
          <Button type="button" label="Save" class="p-button-success" style="margin-right: 0.25em" @click="visibleFull = false" />
